...
namespace WabMaker.Web
{
    ...
    public class IdentityTool
    {
        ...
        public static void Authentication(IAuthenticationManager authenticationManager, bool rememberMe, string id, string account, string displayName, params string[] permissions)
        {
